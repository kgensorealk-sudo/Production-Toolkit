...
const LandingPage: React.FC = () => {
    ...
    // If permissions updated, auto-redirect
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 relative">
            ...
            <div className="bg-slate-900 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden animate-scale-in">
                ...
                <div className="relative z-10">
                    <h2 className="text-3xl font-bold text-white mb-6">Ready to accelerate your workflow?</h2>
                    <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
                        Upgrade your account to gain full access to the Dashboard and all automation tools.
                    </p>
                    <button 
                        onClick={() => setShowContactModal(true)}
                        className="bg-white text-slate-900 hover:bg-indigo-50 font-bold py-4 px-10 rounded-xl shadow-lg transform transition-all hover:-translate-y-1 active:scale-95 text-lg"
                    >
                        Subscribe Now
                    </button>
